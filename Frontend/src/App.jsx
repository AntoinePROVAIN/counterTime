  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route path="/form/:mois/:jour" element={<> <div className='global'><Entete nom={name}/> <div className='centre'><Form updateHeure={updateHeure} getHeure={(mois, jour) => getHeuresDuMois(mois)[jour - 1]}/> </div></div></>} />
